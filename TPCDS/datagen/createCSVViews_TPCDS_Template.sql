...
create or replace view customer_csvScaleFactor as select 
 case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as c_customer_sk, 
 case when (columns[1]='') then cast(null as varchar(200)) else cast(columns[1] as varchar(200)) end as c_customer_id, 
 case when (columns[2]='') then cast(null as bigint) else cast(columns[2] as bigint) end as c_current_cdemo_sk, 
 case when (columns[3]='') then cast(null as bigint) else cast(columns[3] as bigint) end as c_current_hdemo_sk, 
 case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as c_current_addr_sk, 
 case when (columns[5]='') then cast(null as bigint) else cast(columns[5] as bigint) end as c_first_shipto_date_sk, 
 case when (columns[6]='') then cast(null as bigint) else cast(columns[6] as bigint) end as c_first_sales_date_sk, 
...
from dfs.`/tpcdsRaw/SFScaleFactor/customer`;

create or replace view customer_address_csvScaleFactor as select 
case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end  as ca_address_sk, 
...
from dfs.`/tpcdsRaw/SFScaleFactor/customer_address`;

create or replace view customer_demographics_csvScaleFactor as select 
case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as cd_demo_sk, 
...
from dfs.`/tpcdsRaw/SFScaleFactor/customer_demographics`;

create or replace view household_demographics_csvScaleFactor as select 
case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as hd_demo_sk,
case when (columns[1]='') then cast(null as bigint) else cast(columns[1] as bigint) end  as hd_income_band_sk, 
...
from dfs.`/tpcdsRaw/SFScaleFactor/household_demographics`;

create or replace view item_csvScaleFactor as select 
case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as i_item_sk, 
...
case when (columns[7]='') then cast(null as bigint) else cast(columns[7] as bigint) end as i_brand_id, 
case when (columns[8]='') then cast(null as varchar(200)) else cast(columns[8] as varchar(200))  end as i_brand, 
case when (columns[9]='') then cast(null as bigint) else cast(columns[9] as bigint) end as i_class_id, 
case when (columns[10]='') then cast(null as varchar(200)) else cast(columns[10] as varchar(200))  end as i_class, 
case when (columns[11]='') then cast(null as bigint) else cast(columns[11] as bigint) end as i_category_id, 
case when (columns[12]='') then cast(null as varchar(200)) else cast(columns[12] as varchar(200))  end as i_category, 
case when (columns[13]='') then cast(null as bigint) else cast(columns[13] as bigint) end as i_manufact_id, 
...
case when (columns[20]='') then cast(null as bigint) else cast(columns[20] as bigint) end as i_manager_id, 
case when (columns[21]='') then cast(null as varchar(200)) else cast(columns[21] as varchar(200))  end as i_product_name 
from dfs.`/tpcdsRaw/SFScaleFactor/item`;

create or replace view promotion_csvScaleFactor as select 
case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as p_promo_sk, 
case when (columns[1]='') then cast(null as varchar(200)) else cast(columns[1] as varchar(200)) end as p_promo_id,
case when (columns[2]='') then cast(null as bigint) else cast(columns[2] as bigint) end as p_start_date_sk, 
case when (columns[3]='') then cast(null as bigint) else cast(columns[3] as bigint) end as p_end_date_sk, 
case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as p_item_sk, 
...
from dfs.`/tpcdsRaw/SFScaleFactor/promotion`;

create or replace view time_dim_csvScaleFactor as select 
case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as t_time_sk, 
...
from dfs.`/tpcdsRaw/SFScaleFactor/time_dim`;

create or replace view date_dim_csvScaleFactor as select 
case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as d_date_sk, 
...
from dfs.`/tpcdsRaw/SFScaleFactor/date_dim`;

create or replace view store_csvScaleFactor as select 
case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as s_store_sk, 
...
case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as s_closed_date_sk, 
...
case when (columns[10]='') then cast(null as bigint) else cast(columns[10] as bigint) end as s_market_id, 
...
case when (columns[14]='') then cast(null as bigint) else cast(columns[14] as bigint) end as s_division_id, 
case when (columns[15]='') then cast(null as varchar(200)) else cast(columns[15] as varchar(200)) end as s_division_name, 
case when (columns[16]='') then cast(null as bigint) else cast(columns[16] as bigint) end as s_company_id, 
...
from dfs.`/tpcdsRaw/SFScaleFactor/store`;

create or replace view store_sales_csvScaleFactor as select 
case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as ss_sold_date_sk, 
case when (columns[1]='') then cast(null as bigint) else cast(columns[1] as bigint) end as ss_sold_time_sk, 
case when (columns[2]='') then cast(null as bigint) else cast(columns[2] as bigint) end as ss_item_sk, 
case when (columns[3]='') then cast(null as bigint) else cast(columns[3] as bigint) end as ss_customer_sk, 
case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as ss_cdemo_sk, 
case when (columns[5]='') then cast(null as bigint) else cast(columns[5] as bigint) end as ss_hdemo_sk, 
case when (columns[6]='') then cast(null as bigint) else cast(columns[6] as bigint) end as ss_addr_sk, 
case when (columns[7]='') then cast(null as bigint) else cast(columns[7] as bigint) end as ss_store_sk, 
case when (columns[8]='') then cast(null as bigint) else cast(columns[8] as bigint) end as ss_promo_sk, 
...
from dfs.`/tpcdsRaw/SFScaleFactor/store_sales`;

create or replace view warehouse_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as w_warehouse_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/warehouse`;

create or replace view ship_mode_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as sm_ship_mode_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/ship_mode`;

create or replace view reason_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as r_reason_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/reason`;

create or replace view income_band_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as ib_income_band_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/income_band`;

create or replace view call_center_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as cc_call_center_sk,
  ...
  case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as cc_closed_date_sk,
  case when (columns[5]='') then cast(null as bigint) else cast(columns[5] as bigint) end as cc_open_date_sk,
  ...
  case when (columns[12]='') then cast(null as bigint) else cast(columns[12] as bigint) end as cc_mkt_id,
...
from dfs.`/tpcdsRaw/SFScaleFactor/call_center`;

create or replace view web_site_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as web_site_sk,
  ...
  case when (columns[5]='') then cast(null as bigint) else cast(columns[5] as bigint) end as web_open_date_sk,
  case when (columns[6]='') then cast(null as bigint) else cast(columns[6] as bigint) end as web_close_date_sk,
  ...
  case when (columns[9]='') then cast(null as bigint) else cast(columns[9] as bigint) end as web_mkt_id,
  ...
  case when (columns[13]='') then cast(null as bigint) else cast(columns[13] as bigint) end as web_company_id,
...
from dfs.`/tpcdsRaw/SFScaleFactor/web_site`;

create or replace view store_returns_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as sr_returned_date_sk,
  case when (columns[1]='') then cast(null as bigint) else cast(columns[1] as bigint) end as sr_return_time_sk,
  case when (columns[2]='') then cast(null as bigint) else cast(columns[2] as bigint) end as sr_item_sk,
  case when (columns[3]='') then cast(null as bigint) else cast(columns[3] as bigint) end as sr_customer_sk,
  case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as sr_cdemo_sk,
  case when (columns[5]='') then cast(null as bigint) else cast(columns[5] as bigint) end as sr_hdemo_sk,
  case when (columns[6]='') then cast(null as bigint) else cast(columns[6] as bigint) end as sr_addr_sk,
  case when (columns[7]='') then cast(null as bigint) else cast(columns[7] as bigint) end as sr_store_sk,
  case when (columns[8]='') then cast(null as bigint) else cast(columns[8] as bigint) end as sr_reason_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/store_returns`;

create or replace view web_page_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as wp_web_page_sk,
  ...
  case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as wp_creation_date_sk,
  case when (columns[5]='') then cast(null as bigint) else cast(columns[5] as bigint) end as wp_access_date_sk,
  case when (columns[6]='') then cast(null as varchar(200)) else cast(columns[6] as varchar(200)) end as wp_autogen_flag,
  case when (columns[7]='') then cast(null as bigint) else cast(columns[7] as bigint) end as wp_customer_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/web_page`;

create or replace view catalog_page_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as cp_catalog_page_sk,
  case when (columns[1]='') then cast(null as varchar(200)) else cast(columns[1] as varchar(200)) end as cp_catalog_page_id,
  case when (columns[2]='') then cast(null as bigint) else cast(columns[2] as bigint) end as cp_start_date_sk,
  case when (columns[3]='') then cast(null as bigint) else cast(columns[3] as bigint) end as cp_end_date_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/catalog_page`;

create or replace view inventory_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as inv_date_sk,
  case when (columns[1]='') then cast(null as bigint) else cast(columns[1] as bigint) end as inv_item_sk,
  case when (columns[2]='') then cast(null as bigint) else cast(columns[2] as bigint) end as inv_warehouse_sk,
  case when (columns[3]='') then cast(null as integer) else cast(columns[3] as integer) end as inv_quantity_on_hand            
from dfs.`/tpcdsRaw/SFScaleFactor/inventory`;

create or replace view catalog_returns_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as cr_returned_date_sk,
  case when (columns[1]='') then cast(null as bigint) else cast(columns[1] as bigint) end as cr_returned_time_sk,
  case when (columns[2]='') then cast(null as bigint) else cast(columns[2] as bigint) end as cr_item_sk,
  case when (columns[3]='') then cast(null as bigint) else cast(columns[3] as bigint) end as cr_refunded_customer_sk,
  case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as cr_refunded_cdemo_sk,
  case when (columns[5]='') then cast(null as bigint) else cast(columns[5] as bigint) end as cr_refunded_hdemo_sk,
  case when (columns[6]='') then cast(null as bigint) else cast(columns[6] as bigint) end as cr_refunded_addr_sk,
  case when (columns[7]='') then cast(null as bigint) else cast(columns[7] as bigint) end as cr_returning_customer_sk,
  case when (columns[8]='') then cast(null as bigint) else cast(columns[8] as bigint) end as cr_returning_cdemo_sk,
  case when (columns[9]='') then cast(null as bigint) else cast(columns[9] as bigint) end as cr_returning_hdemo_sk,
  case when (columns[10]='') then cast(null as bigint) else cast(columns[10] as bigint) end as cr_returning_addr_sk,
  case when (columns[11]='') then cast(null as bigint) else cast(columns[11] as bigint) end as cr_call_center_sk,
  case when (columns[12]='') then cast(null as bigint) else cast(columns[12] as bigint) end as cr_catalog_page_sk,
  case when (columns[13]='') then cast(null as bigint) else cast(columns[13] as bigint) end as cr_ship_mode_sk,
  case when (columns[14]='') then cast(null as bigint) else cast(columns[14] as bigint) end as cr_warehouse_sk,
  case when (columns[15]='') then cast(null as bigint) else cast(columns[15] as bigint) end as cr_reason_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/catalog_returns`;

create or replace view web_returns_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as wr_returned_date_sk,
  case when (columns[1]='') then cast(null as bigint) else cast(columns[1] as bigint) end as wr_returned_time_sk,
  case when (columns[2]='') then cast(null as bigint) else cast(columns[2] as bigint) end as wr_item_sk,
  case when (columns[3]='') then cast(null as bigint) else cast(columns[3] as bigint) end as wr_refunded_customer_sk,
  case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as wr_refunded_cdemo_sk,
  case when (columns[5]='') then cast(null as bigint) else cast(columns[5] as bigint) end as wr_refunded_hdemo_sk,
  case when (columns[6]='') then cast(null as bigint) else cast(columns[6] as bigint) end as wr_refunded_addr_sk,
  case when (columns[7]='') then cast(null as bigint) else cast(columns[7] as bigint) end as wr_returning_customer_sk,
  case when (columns[8]='') then cast(null as bigint) else cast(columns[8] as bigint) end as wr_returning_cdemo_sk,
  case when (columns[9]='') then cast(null as bigint) else cast(columns[9] as bigint) end as wr_returning_hdemo_sk,
  case when (columns[10]='') then cast(null as bigint) else cast(columns[10] as bigint) end as wr_returning_addr_sk,
  case when (columns[11]='') then cast(null as bigint) else cast(columns[11] as bigint) end as wr_web_page_sk,
  case when (columns[12]='') then cast(null as bigint) else cast(columns[12] as bigint) end as wr_reason_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/web_returns`;

create or replace view web_sales_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as ws_sold_date_sk,
  case when (columns[1]='') then cast(null as bigint) else cast(columns[1] as bigint) end as ws_sold_time_sk,
  case when (columns[2]='') then cast(null as bigint) else cast(columns[2] as bigint) end as ws_ship_date_sk,
  case when (columns[3]='') then cast(null as bigint) else cast(columns[3] as bigint) end as ws_item_sk,
  case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as ws_bill_customer_sk,
  case when (columns[5]='') then cast(null as bigint) else cast(columns[5] as bigint) end as ws_bill_cdemo_sk,
  case when (columns[6]='') then cast(null as bigint) else cast(columns[6] as bigint) end as ws_bill_hdemo_sk,
  case when (columns[7]='') then cast(null as bigint) else cast(columns[7] as bigint) end as ws_bill_addr_sk,
  case when (columns[8]='') then cast(null as bigint) else cast(columns[8] as bigint) end as ws_ship_customer_sk,
  case when (columns[9]='') then cast(null as bigint) else cast(columns[9] as bigint) end as ws_ship_cdemo_sk,
  case when (columns[10]='') then cast(null as bigint) else cast(columns[10] as bigint) end as ws_ship_hdemo_sk,
  case when (columns[11]='') then cast(null as bigint) else cast(columns[11] as bigint) end as ws_ship_addr_sk,
  case when (columns[12]='') then cast(null as bigint) else cast(columns[12] as bigint) end as ws_web_page_sk,
  case when (columns[13]='') then cast(null as bigint) else cast(columns[13] as bigint) end as ws_web_site_sk,
  case when (columns[14]='') then cast(null as bigint) else cast(columns[14] as bigint) end as ws_ship_mode_sk,
  case when (columns[15]='') then cast(null as bigint) else cast(columns[15] as bigint) end as ws_warehouse_sk,
  case when (columns[16]='') then cast(null as bigint) else cast(columns[16] as bigint) end as ws_promo_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/web_sales`;

create or replace view catalog_sales_csvScaleFactor as select 
  case when (columns[0]='') then cast(null as bigint) else cast(columns[0] as bigint) end as cs_sold_date_sk,
  case when (columns[1]='') then cast(null as bigint) else cast(columns[1] as bigint) end as cs_sold_time_sk,
  case when (columns[2]='') then cast(null as bigint) else cast(columns[2] as bigint) end as cs_ship_date_sk,
  case when (columns[3]='') then cast(null as bigint) else cast(columns[3] as bigint) end as cs_bill_customer_sk,
  case when (columns[4]='') then cast(null as bigint) else cast(columns[4] as bigint) end as cs_bill_cdemo_sk,
  case when (columns[5]='') then cast(null as bigint) else cast(columns[5] as bigint) end as cs_bill_hdemo_sk,
  case when (columns[6]='') then cast(null as bigint) else cast(columns[6] as bigint) end as cs_bill_addr_sk,
  case when (columns[7]='') then cast(null as bigint) else cast(columns[7] as bigint) end as cs_ship_customer_sk,
  case when (columns[8]='') then cast(null as bigint) else cast(columns[8] as bigint) end as cs_ship_cdemo_sk,
  case when (columns[9]='') then cast(null as bigint) else cast(columns[9] as bigint) end as cs_ship_hdemo_sk,
  case when (columns[10]='') then cast(null as bigint) else cast(columns[10] as bigint) end as cs_ship_addr_sk,
  case when (columns[11]='') then cast(null as bigint) else cast(columns[11] as bigint) end as cs_call_center_sk,
  case when (columns[12]='') then cast(null as bigint) else cast(columns[12] as bigint) end as cs_catalog_page_sk,
  case when (columns[13]='') then cast(null as bigint) else cast(columns[13] as bigint) end as cs_ship_mode_sk,
  case when (columns[14]='') then cast(null as bigint) else cast(columns[14] as bigint) end as cs_warehouse_sk,
  case when (columns[15]='') then cast(null as bigint) else cast(columns[15] as bigint) end as cs_item_sk,
  case when (columns[16]='') then cast(null as bigint) else cast(columns[16] as bigint) end as cs_promo_sk,
...
from dfs.`/tpcdsRaw/SFScaleFactor/catalog_sales`;
